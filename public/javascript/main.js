...
(function() {
  ...
  String.prototype.tokens = function() {
    var COMPARISON, ID, MULTIPLELINECOMMENT, NUM, ONECHAROPERATORS, ONELINECOMMENT, RESERVED_WORD, STRING, WHITES, from, getTok, i, m, make, n, result, rw, tokens;
    from = void 0;
    i = 0;
    n = void 0;
    m = void 0;
    ...
    MULTIPLELINECOMMENT = /\/[*](.|\n)*?[*]\//g;
    ONECHAROPERATORS = /([-+*\/=()&|;:,<>{}[\]])/g;
    tokens = [WHITES, ID, NUM, STRING, ONELINECOMMENT, COMPARISON, MULTIPLELINECOMMENT, ONECHAROPERATORS];
    RESERVED_WORD = {
      p: "P",
      "if": "IF",
      then: "THEN"
